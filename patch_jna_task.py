# -*- coding: utf-8 -*-
import pathlib
# Add a Gradle task that patches the JNA jar to include android dispatchers
# The task will run before the AAR is built and modify the JNA jar in the gradle cache
D = chr(36)
...
print('rewrote with patch task stub')
